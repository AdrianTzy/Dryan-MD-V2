...
let handler = async (m, { conn, args, usedPrefix, command }) => {
    if (!args[0]) throw `Use example ${usedPrefix}${command} https://www.instagram.com/p/xxxxxxxxxxx`
    let sayang = await fetch(`https://saipulanuar.ga/api/downloader/instagram?url=${args[0]}&apikey=zahirgans`)
